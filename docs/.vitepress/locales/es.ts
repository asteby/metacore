      ...
      '/es/sdk/': [
        {
          ...
          items: [
            ...
            { text: 'WASM ABI', link: '/es/sdk/wasm-abi' },
            { text: 'Federación', link: '/es/sdk/federation' },
            { text: 'Federación de página completa', link: '/es/sdk/full-page-federation' },
            { text: 'Modals', link: '/es/sdk/modals' },
            { text: 'Bridge API', link: '/es/sdk/bridge-api' },
            { text: 'Prioridad de slots', link: '/es/sdk/slot-priority' },
          ],
        },
      ],
      '/es/kernel/': [
