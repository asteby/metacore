...
- **Go 1.25+** para el kernel y cualquier backend de host.
- **PostgreSQL 14+.** La base de datos soportada — el gating de SQL del runtime depende de ella. (SQLite se usa solo dentro de los tests del propio kernel.)
