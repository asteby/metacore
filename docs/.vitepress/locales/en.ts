      ...
      '/sdk/': [
        {
          ...
          items: [
            ...
            { text: 'WASM ABI', link: '/sdk/wasm-abi' },
            { text: 'Federation', link: '/sdk/federation' },
            { text: 'Full-Page Federation', link: '/sdk/full-page-federation' },
            { text: 'Modals', link: '/sdk/modals' },
            { text: 'Bridge API', link: '/sdk/bridge-api' },
            { text: 'Slot Priority', link: '/sdk/slot-priority' },
          ],
        },
      ],
      '/kernel/': [
