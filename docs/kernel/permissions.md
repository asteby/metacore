...
| ---------------------- | ------------- | ---------------------------------------------------------- | -------- |
| `permission.Service`   | Authenticated user (HTTP) | May this user perform action X on resource Y?  | [`permission/`](https://github.com/asteby/metacore-kernel/blob/main/permission/) |
| `security.Enforcer`    | Installed addon            | May this addon DB-write / HTTP-fetch / emit?    | [`security/`](https://github.com/asteby/metacore-kernel/blob/main/security/)     |
...
check. See [`permission/capability.go`](https://github.com/asteby/metacore-kernel/blob/main/permission/capability.go).
...
Two implementations ship in [`permission/store.go`](https://github.com/asteby/metacore-kernel/blob/main/permission/store.go):
...
Roles are typed strings ([`permission/roles.go`](https://github.com/asteby/metacore-kernel/blob/main/permission/roles.go)).
...
The contract is in [`manifest/manifest.go`](https://github.com/asteby/metacore-kernel/blob/main/manifest/manifest.go) (type
`Capability`) and the enforcement in
[`security/context.go`](https://github.com/asteby/metacore-kernel/blob/main/security/context.go) (type `Capabilities`).
...
- [`dynamic-system.md`](./dynamic-system) — how the user gate fires per CRUD request.
- [`dynamic-api.md`](./dynamic-api) — `403` response shape.
- [`consumer-guide.md`](./consumer-guide), section *Capability model and security modes*.
- [`embedding-quickstart.md`](./embedding-quickstart) — wiring the store from main.go.
- [`../manifest/manifest.go`](https://github.com/asteby/metacore-kernel/blob/main/manifest/manifest.go) — manifest type definitions.
- [`../permission/service.go`](https://github.com/asteby/metacore-kernel/blob/main/permission/service.go), [`../security/enforcer.go`](https://github.com/asteby/metacore-kernel/blob/main/security/enforcer.go) — implementations.
