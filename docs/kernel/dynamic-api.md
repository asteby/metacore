...
For the conceptual walkthrough see [`dynamic-system.md`](./dynamic-system).
...
- `:model` is the registry key passed to
  [`App.RegisterModel(key, factory)`](https://github.com/asteby/metacore-kernel/blob/main/host/app.go) — usually the
...
- Response shapes are produced by `dynamic.Handler`
  ([`dynamic/handler.go`](https://github.com/asteby/metacore-kernel/blob/main/dynamic/handler.go)) and
...
[`dynamic/handler.go:handleError`](https://github.com/asteby/metacore-kernel/blob/main/dynamic/handler.go) and
...
([`query/builder.go`](https://github.com/asteby/metacore-kernel/blob/main/query/builder.go)) — its JSON tags are part of
the public API.
...
([`dynamic/model.go`](https://github.com/asteby/metacore-kernel/blob/main/dynamic/model.go)). Type mismatches surface as
`400 invalid input`. Cross-field validation is the addon's job — register
a hook on `dynamic.Hooks` ([`dynamic/hooks.go`](https://github.com/asteby/metacore-kernel/blob/main/dynamic/hooks.go)).
...
[`metadata/handler.go`](https://github.com/asteby/metacore-kernel/blob/main/metadata/handler.go). The host wires them under
`/metadata`:
...
([`modelbase/metadata.go`](https://github.com/asteby/metacore-kernel/blob/main/modelbase/metadata.go)). Every JSON tag is
...
in [`query/filter.go`](https://github.com/asteby/metacore-kernel/blob/main/query/filter.go). When `<op>:` is omitted, the
...
See also: [`dynamic-system.md`](./dynamic-system),
